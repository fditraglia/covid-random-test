...
A third way of deciding how many samples are needed is by calculating the chance that we will be able to distinguish, with high confidence, between two different levels of coronavirus prevalence given a particular sample size. 
