...
```{r echo = FALSE}
get_cv <- function(n, C0, N = 3000, alpha = 0.1) {
  qhyper(1 - alpha, C0, N - C0, n)
}
get_exact_alpha <- function(n, C0, N = 3000, alpha = 0.1) {
  phyper(get_cv(n, C0, N, alpha), C0, N - C0, n)
}
get_exact_power <- function(cv, n, C0, C, N = 3000) {
...
- So the real question is whether the specificity of 
